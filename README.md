...
The entire content of this repository — including the code, build configuration, `PORT_NOTES.md`, this README, and the Forge 1.20.1 port itself — was **generated by [DeepSeek-V4-Flash](https://www.deepseek.com/)**, an AI language model, under human direction.
